...
origin = testbench("Q1/testbench_driver.c", "Q1/conv2d.S", "Q1/a.out", "Q1/ans.output")
origin.compile()
origin.run()
origin.print()
print("-----------------------------------")
...
improve = testbench("Q1/testbench_driver.c", "Q1/conv2d-better.S", "Q1/a.out", "Q1/stu.output")
improve.compile()
improve.run()
improve.print()
print("-----------------------------------")
...
correct_result = open("Q1/ans.output", 'r')
student_result = open("Q1/stu.output", 'r')
